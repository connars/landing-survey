$(document).ready(function () {
	...
	$('#tab1 .tasks-field-wrap ').click(function (e) {
...

		{
			...
			var html = $('#tab1 .active-item').text();
	...
	$('#tab2 .tasks-field-wrap ').click(function (e) {
...

		{
			...
			var html = $('#tab2 .active-item').text();
	...
	$('#tab3 .tasks-field-wrap ').click(function (e) {
...

		{
			...
			var html = $('#tab3 .active-item').text();
	...
	$('#tab4 .tasks-field-wrap ').click(function (e) {
...

		{
			...
			var html = $('#tab4 .active-item').text();
	...
	$('#tab5 .tasks-field-wrap ').click(function (e) {
...

		{
			...
			var html = $('#tab5 .active-item').text();
	...
	$('#tab6 .tasks-field-wrap ').click(function (e) {
...

		{
			...
			var html = $('#tab6 .active-item').text();
	...
	$('#tab7 .tasks-field-wrap ').click(function (e) {
...

		{
			...
			var html = $('#tab7 .active-item').text();
	...
	$('#tab8 .tasks-field-wrap ').click(function (e) {
...

		{
			...
			var html = $('#tab8 .active-item').text();
	...
	$('#tab9 .tasks-field-wrap ').click(function (e) {
...

		{
			...
			var html = $('#tab9 .active-item').text();
	...
	$('.form-button').click(function () {
		...
		if ($(".form ").valid()) {
			...
			if (country == "Azerbaijan" || phoneCountry == "994") {
				...
				// sendAdditionalDatal = `&cid=6038&referral=fillaz&brandName=FICRM&country=${country}&prefix=${phoneCountry}&fname=${firstName}&lname=${lastName}&email=${email}&phone=${_phoneNumber}&utm_source=${utmsource}`
			}
			else {
				sendAdditionalDatal = {
					"url": "https://investor-test.top/?bcode=0976",
					"email": email,
					"fname": firstName,
					"lname": lastName,
					"prefix": phoneCountry,
				...
				// sendAdditionalDatal = `&cid=1755&referral=fillru&brandName=FICRM&country=${country}&prefix=${phoneCountry}&fname=${firstName}&lname=${lastName}&email=${email}&phone=${_phoneNumber}&utm_source=${utmsource}`
			}
			$('#preloader').show();
			...
			var req = $.ajax({
				...
				data: JSON.stringify(
					// "url": "https://investor-test.top/?bcode=0976",
					// "additionalData": sendAdditionalDatal
